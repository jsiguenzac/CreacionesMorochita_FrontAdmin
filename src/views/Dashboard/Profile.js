		...
		<Flex direction='column' mt={{ sm: '25px', md: '0px' }}>
			...
			<Grid
				...
				<Card
					...
					maxH={{ md: '410px' }}
					maxW={{ sm: '325px', md: '725px', lg: '980px' }}
					maxWidth={{ sm: '325px', md: '725px', lg: '980px' }}
					...
					<CardHeader p='12px 5px' mb='12px'>
						<Flex direction='column'>
							...
							<Text fontSize='sm' color='gray.400'>
								Hola, Mark Johnson! observa tu información actualizada.
							</Text>
						</Flex>
					</CardHeader>
					<CardBody w='100%'>
			...
			*/}
			...
			<Flex
				...
				w="100%" // Full width
				gap="24px" // Spacing between the cards
				>
				{/* Información Card */}
				<Card
					p="16px"
				...
				<Card
					...
					flexBasis="380px" // Set a fixed width for this card
				>
					<CardHeader p="12px 5px" mb="12px">
					<Text fontSize="lg" color="#fff" fontWeight="bold">
						DATOS PERSONALES
